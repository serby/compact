...
describe('compact.js', function() {
  ...
  describe('#createCompact()', function() {
    ...
    it('should succeed with valid paths', function() {
      require('../../compact')
        .createCompact({ srcPath: srcPath, destPath: destPath })
  ...
  describe('Namespace', function() {
    ...
    describe('access via .ns', function() {
      ...
      it('should not be able to mess with a namespace', function() {
        ...
        ;(function() {
          ...
          "You can not alter a registered namespace 'global'"
        ))
      })
    })
    ...
    describe('#addJs()', function() {
      ...
      it('should be chainable', function() {
        namespace.addJs('a.js').addJs('b.js')
      })

      it('should be able to add via .ns', function() {
        compact.ns.global.addJs('a.js').addJs('b.js')
      })
    })
  ...
  describe('#middleware()', function() {
    ...
    beforeEach(function() {
      ...
      compactDebug = require('../../compact').createCompact({
        srcPath: srcPath,
        destPath: destPath,
        debug: true
      })
    ...
    it('should have a correct helper when given valid input for multiple groups', function(done) {
      compact.addNamespace('global').addJs('/a.js')

      compact.addNamespace('blog').addJs('/b.js')
    ...
    it(
      'should differentiate between files with the same name from ' +
        'different locations in different namespaces',
      function(done) {
        var compactDebug = require('../../compact').createCompact({
          srcPath: srcPath,
          destPath: destPath,
        ...
        compactDebug.addNamespace('global').addJs('/a.js')
    ...
    it(
      'should differentiate between files with the same name from ' +
        'different locations from the same namespace',
      function(done) {
        var compactDebug = require('../../compact').createCompact({
          srcPath: altPath,
          destPath: destPath,
